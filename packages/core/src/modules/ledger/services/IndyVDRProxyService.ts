...
import type { VdrPoolConfig, PublicDidRequestVDR } from './VdrPoolProxy'
...
import { LedgerNotConfiguredError, LedgerNotFoundError, LedgerError } from '../error'
