...
export abstract class LedgerServiceInterface{
    ...
    abstract setPools(poolsConfigs: IndyPoolConfig[]): void

    abstract connectToPools(): Promise<number[]>
    ...
    abstract registerCredentialDefinition(agentContext: AgentContext, did: string, createCredentialDefinition: CredentialDefinitionTemplate): Promise<CredDef>

    abstract getCredentialDefinition(agentContext: AgentContext, credentialDefinitionId: string): Promise<CredDef>

    abstract getRevocationRegistryDefinition(agentContext: AgentContext, revocationRegistryDefinitionId: string): Promise<ParseRevocationRegistryDefinitionTemplate>

    abstract getRevocationRegistryDelta(agentContext: AgentContext, revocationRegistryDefinitionId: string, to: number,from: number): Promise<ParseRevocationRegistryDeltaTemplate>

    abstract getRevocationRegistry(agentContext: AgentContext, revocationRegistryDefinitionId: string, timestamp: number): Promise<ParseRevocationRegistryTemplate>
