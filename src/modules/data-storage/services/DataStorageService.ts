...
export class DataStorageService {
  ...
  public constructor(@inject(Symbols.Wallet) wallet: Wallet, genericDataRepository: GenericDataRepository) {
    this.wallet = wallet
   ...
   */
  public async addGenericData(key: string, value: any, mimeType: string, tags?: Tags): Promise<GenericDataRecord> {
